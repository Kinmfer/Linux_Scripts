...
tool_info() {
    echo -e "========================================================================================="
    echo -e "                             Init CentOS 7/8 tool for Kinmfer                              "
...
install_necessary_software() {
    dnf -y install net-tools tree nmap lrzsz dos2unix telnet screen vim lsof wget iftop bash-completion tcpdump   &>/dev/null
}
